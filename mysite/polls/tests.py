...
class QuestionIndexViewTests(TestCase):
    INDEX_NULL_RESPONSE = "No polls are available."
    INDEX_QUERYSET = 'latest_question_list'
    ...
    def test_no_questions(self):
        ...
        self.assertContains(response, self.INDEX_NULL_RESPONSE)

        self.assertQuerysetEqual(
            response.context[self.INDEX_QUERYSET], [])
    ...
    def test_past_qustion(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context[self.INDEX_QUERYSET],
